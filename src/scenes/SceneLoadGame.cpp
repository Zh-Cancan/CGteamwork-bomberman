...
void SceneLoadGame::load() {
	...
	//	// - Get files in homeDir+SAVE_DIR by last write time order
	//	boost::filesystem::path saveDir(homeDir+SAVE_DIR);
	...
	//		}
	//	} else {
	//		logErr("Cannot open '" << homeDir+SAVE_DIR << "'");
	//	}
